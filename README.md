...
### Frontend
- ![React 19](https://img.shields.io/badge/React-19.0-61DAFB?style=flat-square&logo=react&logoColor=black) **React 19** with Hooks & Modern State Management
- ![TypeScript](https://img.shields.io/badge/TypeScript-5.5-3178C6?style=flat-square&logo=typescript&logoColor=white) **TypeScript** for Strict Type Safety
- ![Vite](https://img.shields.io/badge/Vite-5.4-646CFF?style=flat-square&logo=vite&logoColor=white) **Vite 5** for Blazing-Fast HMR Bundling
- ![Tailwind CSS](https://img.shields.io/badge/Tailwind_CSS-3.4-38B2AC?style=flat-square&logo=tailwind-css&logoColor=white) **Tailwind CSS** & Custom Glassmorphic Design System
- ![Lucide Icons](https://img.shields.io/badge/Lucide_React-0.344-F56565?style=flat-square) **Lucide Icons** & Framer Motion UI Animations

### Backend
- ![Spring Boot](https://img.shields.io/badge/Spring_Boot-3.3-6DB33F?style=flat-square&logo=springboot&logoColor=white) **Spring Boot 3.3** REST Controller Architecture
- ![Java 21](https://img.shields.io/badge/Java-21_LTS-ED8B00?style=flat-square&logo=openjdk&logoColor=white) **Java 21 LTS** Virtual Threads & Records
- ![Spring Data JPA](https://img.shields.io/badge/Spring_Data_JPA-3.3-6DB33F?style=flat-square) **Spring Data JPA** & Hibernate ORM
- ![Spring Security](https://img.shields.io/badge/Spring_Security-6.3-6DB33F?style=flat-square&logo=springsecurity&logoColor=white) **Spring Security 6** & JWT Authorization Filters

### Database & Security
- ![PostgreSQL](https://img.shields.io/badge/PostgreSQL-16-336791?style=flat-square&logo=postgresql&logoColor=white) **PostgreSQL 16** Relational Persistence (with H2 Cloud Fallback)
- ![Redis](https://img.shields.io/badge/Redis-7.2-DC382D?style=flat-square&logo=redis&logoColor=white) **Redis Cache** Session & Rate Limiting
- ![JWT](https://img.shields.io/badge/JWT-256--Bit-000000?style=flat-square&logo=jsonwebtokens) **HMAC-SHA256 JWT** Token Authentication

### Deployment & Dev Tools
- ![Vercel](https://img.shields.io/badge/Vercel-CDN_Edge-000000?style=flat-square&logo=vercel&logoColor=white) **Vercel** Edge Global Frontend Hosting
- ![Render](https://img.shields.io/badge/Render-Cloud_PaaS-46E3B7?style=flat-square&logo=render&logoColor=white) **Render** Cloud Docker Web Service Container
- ![Git](https://img.shields.io/badge/Git-Version_Control-F05032?style=flat-square&logo=git&logoColor=white) **Git & GitHub** Version Control
